...
- Spreads ALL items across ${nights} day(s). Aim for 5-7 stops per day, but
  go higher when the user has packed many items (it is FAR more important
  to include every chosen item than to stay under a per-day count).
