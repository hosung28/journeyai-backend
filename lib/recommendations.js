...
function buildCombinedPrompt({
  ...
  return `Plan a personalised travel guide for a ${nights}-night destination in ${city} (${travelers} traveler${travelers > 1 ? "s" : ""}).
...
{
  "places": [
    {"name":"Real name","area":"Neighborhood/district","type":"Temple|Museum|Park|Viewpoint|Market|Landmark|Gallery|etc.","duration":"e.g. 2h or 45 min","bestTime":"Morning|Afternoon|Evening","rating":4.5,"tags":["tag1","tag2"],"cost":0,"whyPicked":"Short rationale, max 15 words","signature":false}
  ],
  "activities": [
    {"name":"Real name","area":"Neighborhood/district","type":"Cooking class|Food tour|Walking tour|Workshop|Spa|Day trip|etc.","duration":"e.g. 3h or Half-day","rating":4.6,"tags":["tag1"],"price":"$|$$|$$$|$$$$","cost":75,"badge":null,"whyPicked":"Short rationale, max 15 words","signature":false}
  ],
  "restaurants": [
    {"name":"Real name","area":"Neighborhood/district","type":"Sushi|Ramen|Italian|Steakhouse|Cafe|etc.","price":"$|$$|$$$|$$$$","rating":4.5,"badge":null,"meal":"Breakfast|Lunch|Dinner","cost":30,"whyPicked":"Short rationale, max 15 words","signature":false}
  ]
}`;
}
